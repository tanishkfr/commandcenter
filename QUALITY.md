...
- An isolated API smoke test covers health, bootstrap, conversation, capture, review, supersession, search, export, undo, delete, and restore.
...
Test desktop and narrow mobile widths. Every visible control must complete a workflow. Verify keyboard order, focus visibility, dialog trapping and return, Escape, grouped search states, the three capture choices, lineage and undo, educational empty states, calm errors, reduced motion, and stable loading geometry.
